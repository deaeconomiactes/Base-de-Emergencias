...
def main():
    ...
    try:
        with conn.cursor() as cur:
            ...
            print("\n--- Asegurando Resolución 9 (DTO 763-2018) ---")
            cur.execute("""
            ...
            if 'apicul' in xl.sheet_names:
                ...
                for idx, row in df.iterrows():
                    ...
                    n_colmenas = int(row.get(colmenas_col[0], 0) or 0) if colmenas_col else 0
